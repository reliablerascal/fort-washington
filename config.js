var config = {
    ...
    chapters: [
        ...
        
        {
            ...
            alignment: 'left',
            hidden: false,
            description: 'Fort Washington Park extends about two and a half miles along the Hudson shoreline in Upper Manhattan, bounded roughly by 158th Street to the south and Dyckman Street to the north.',
            location: {
        ...
        
        {
            ...
            description: 'An older entry path at 176th remains isolated from both the park and the city, strewn with discarded clothes, garbage, and luggage cases as it weaves through tunnels and underpasses.',
            location: {
